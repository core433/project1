...
ActiveRecord::Schema.define(:version => 20121126063903) do
  ...
  create_table "rel_projects", :force => true do |t|
    t.integer  "user_id"
  ...
  add_index "rel_projects", ["project_id"], :name => "index_rel_projects_on_project_id"
